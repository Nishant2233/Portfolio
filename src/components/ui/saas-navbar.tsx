...
export function SaasNavbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-center items-start pointer-events-none">
        <div
          className={cn(
            glass,
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={cn(
                "font-medium px-4 py-2 rounded-xl transition-all duration-300",
